...
class AttributeCalculator_OptionsManager {
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'attribute-calculator');
            case 'false':
                return __('false', 'attribute-calculator');

            case 'Administrator':
                return __('Administrator', 'attribute-calculator');
            case 'Editor':
                return __('Editor', 'attribute-calculator');
            case 'Author':
                return __('Author', 'attribute-calculator');
            case 'Contributor':
                return __('Contributor', 'attribute-calculator');
            case 'Subscriber':
                return __('Subscriber', 'attribute-calculator');
            case 'Anyone':
                return __('Anyone', 'attribute-calculator');
        }
        return $optionValue;
    }
