...
include_once('AttributeCalculator_ShortCodeLoader.php');
 ...
 */
abstract class AttributeCalculator_ShortCodeScriptLoader extends AttributeCalculator_ShortCodeLoader {
